...
{
    public static UEvent OnJumped = new UEvent();
    public static UEvent OnLanded = new UEvent();
    public static UEvent OnFalling = new UEvent();
    ...
    void Start()
    {
        ...
        PlayerAimController.OnLockTarget.Subscribe(eventHandler, () => isInLockState = true);
        PlayerAimController.OnUnlockTarget.Subscribe(eventHandler, () => isInLockState = false);
        ...
        PlayerUIManager.OnStartedDialogue.Subscribe(eventHandler, (x, y) => isFrozen = true);
        PlayerUIManager.OnFinishedDialogue.Subscribe(eventHandler, () => isFrozen = false);
        LevelManager.OnRestartLevel.Subscribe(eventHandler, ResetPlayerPos);
    ...
    {
        await Task.Delay(LevelManager.currentManager.resetFreezeDurationMs);
